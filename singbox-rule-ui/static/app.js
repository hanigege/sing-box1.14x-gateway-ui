const translations = {
  en: {
    ...
    tproxyPolicy: "LAN/private and node server IPs bypass TProxy. FakeIP ranges are captured by TProxy and handled by sing-box.",
  ...
  zh: {
    ...
    tproxyPolicy: "内网/本机网段和节点服务器 IP 会绕过 TProxy；FakeIP 网段不会绕过，会交给 sing-box 分流。",
